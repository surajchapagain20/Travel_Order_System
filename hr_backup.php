...
// Only Admin should access backup
...
unset($_SESSION['message']);
    ...
    if (isset($_POST['backup'])) {
        ...
        // Include DB config to get database name
        require_once 'db.php';
        $database = DB_NAME; // HR database name
        // Build command to dump only the HR database
        $command = "$mysqlPathEscaped -u $mysqlUserEscaped $mysqlPasswordPart $database > $backupFileEscaped";
...
<head>
	...
	<head>
    <title>Travel Expense | HR Portal</title>
